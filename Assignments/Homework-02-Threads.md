...
Create a file called `getimgur.py` in your `/opt/4130repo/assignments/

For now, make it all run! I'll post more about what I want you to turn in. And READ the threading overview!
